        ...
        <div>
            <section className="py-10 bg-slate-900 sm:py-16 lg:py-24">
                <div className="max-w-2xl mx-auto py-20 text-center">
                    <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">Data policy</h2>
                    <p className="max-w-2xl mx-auto mt-4 text-base leading-relaxed text-gray-600">Our data policy is committed to protecting your privacy and the security of your personal information.
                ...
                <section className="py-10 bg-slate-900 sm:py-16 lg:py-24">
                    <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                        ...
                        <div className="grid max-w-xl grid-cols-1 mx-auto mt-8 text-center lg:max-w-full sm:mt-12 lg:mt-20 lg:grid-cols-3 gap-x-6 xl:gap-x-12 gap-y-6">
                            <div className="overflow-hidden bg-slate-300 rounded-md shadow">
                            ...
                            <div className="relative overflow-hidden bg-slate-300 rounded-md shadow transition-all duration-500 hover:text-white group">
                                <div className="absolute inset-0 bg-black transition-all duration-500 transform scale-0 group-hover:scale-150"></div>
                                <div className="relative px-8 py-12 transition-colors duration-500 group-hover:text-white">
                                    <div className="relative w-24 h-24 mx-auto">
                                    ...
                                    <blockquote className="mt-7">
                                        <p className="text-lg text-black group-hover:text-white transition-colors duration-500">“Amet minim mollit non deserunt ullam co est sit aliqua dolor do amet sint. Velit officia consequat duis enim velit mollit. Exercitation veniam consequat”</p>
                                    </blockquote>
                                    <p className="text-base font-semibold mt-9 text-black group-hover:text-white transition-colors duration-500">Robert Fox</p>
                                    <p className="mt-1 text-base text-gray-600 group-hover:text-gray-400 transition-colors duration-500">Founder at Brain.co</p>
                                </div>
                            </div>
                            ...
                            <div className="divide-y divide-gray--200 -my-9">
                                ...
                                <div className="py-9">
                                    ...
                                    <p className="mt-3 text-base text-gray-600">
                                        Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt <a href="#" title="" className="text-blue-600 transition-all duration-200 hover:text-blue-700 focus:text-blue-700 hover:underline">SticketMovie@gmail.com</a>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <section>
                <section className="pt-10 pb-8 overflow-hidden bg-slate-900 sm:pt-16 lg:pt-24">
                    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                        <div className="max-w-2xl mx-auto text-center">
                            <h2 className="text-3xl font-bold leading-tight text-white sm:text-4xl lg:text-5xl">Connect with all apps</h2>
                            ...
                            <a
                                href="#"
                                title=""
                                className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white transition-all duration-200 border-2 border-gray-200 rounded-md mt-9 hover:bg-gray-900 hover:text-white hover:border-gray-900 focus:bg-gray-900 focus:text-white focus:border-gray-900"
                                role="button"
                            >
                                Check all apps
                            </a>
            ...
            <section>
                <section className="pt-10 bg-slate-900 sm:pt-16 lg:pt-24">
                    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                        <div className="max-w-2xl mx-auto text-center">
                            ...
                            <a href="/cinema/contact" title="" className="inline-flex items-center justify-center px-6 py-4 mt-12 text-base font-semibold text-white transition-all duration-200 bg-blue-600 border border-transparent rounded-md hover:bg-blue-700 focus:bg-blue-700" role="button">
